...
`docs/flow/worklog/<TICKET-ID>/progress.md` (default the configured `vcs.base`; a sibling branch for a
...
`docs/flow/worklog/<TICKET-ID>/ship/branch-hardening.md`, each with: agent, `file:line`, severity
...
`docs/flow/worklog/<TICKET-ID>/ship/branch-hardening.md` — findings, resolutions, and any explicit
