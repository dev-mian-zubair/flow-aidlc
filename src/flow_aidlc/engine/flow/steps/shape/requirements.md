...
Record enabled optional guardrails in `worklog/<PI-NNN>/progress.md` under a
...
`worklog/<PI-NNN>/questions/requirements.questions.md` per
...
```bash
cp .flow/templates/requirements.tmpl.md worklog/<PI-NNN>/shape/requirements.md
```
