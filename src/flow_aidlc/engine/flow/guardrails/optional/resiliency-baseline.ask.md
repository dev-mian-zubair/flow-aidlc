...
The RES guardrail enforces reliability patterns as blocking checks at Build/verify: explicit timeouts on every external call, idempotent retry operations, graceful degradation on dependency outages, and re-runnable background/queue tasks. Directional reliability guidance, applied to your service boundaries.
